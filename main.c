...
const char correct_password[PASSWORD_LENGTH + 1] = "5578"; 
        ...
        if (key != 0 && last_key == 0) {
            ...
            if (key == '#') { 
                ...
                if (input_idx == PASSWORD_LENGTH && strncmp(input_buffer, correct_password, PASSWORD_LENGTH) == 0) {
                    ...
                    display_buf[0] = SEG_MINUS;
                    display_buf[1] = SEG_BLANK;
                    display_buf[2] = SEG_P;
                    display_buf[3] = SEG_A;
                    display_buf[4] = SEG_S;
                    display_buf[5] = SEG_S;
                    display_buf[6] = SEG_BLANK;
                    display_buf[7] = SEG_MINUS;
                    ...
                    display_buf[0] = SEG_BLANK;
                    display_buf[1] = SEG_MINUS;
                    display_buf[2] = SEG_F;
                    display_buf[3] = SEG_A;
                    display_buf[4] = SEG_I;
                    display_buf[5] = SEG_L;
                    display_buf[6] = SEG_MINUS;
